...
# 📈 Monthly Progress Summary: {month_name} {year}
...
## 🎯 Insights
- **Weight Trend:** {'🔥 Losing' if stats.get('weight_delta', 0) < 0 else '📈 Gaining/Stable'}
- **Performance:** {'✅ Progressing' if stats.get('avg_tut', 0) > 60 else '⚠️ Focus on Intensity'}
