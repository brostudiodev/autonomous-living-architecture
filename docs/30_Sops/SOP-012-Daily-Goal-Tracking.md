...
*   **Sync failure:** Verify that your goal links follow the format `[P - Workout - Reach Target Body Fat](../10_Goals/G01_Target-Body-Fat/README.md)` and that the `GXX` code is correct.
