---
title: "Archived Automation Spec: cleanup_orphaned_config"
...
# Archived Automation Spec: cleanup_orphaned_config

## Purpose
Preserves the historical documentation record for `cleanup_orphaned_config` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `cleanup_orphaned_config` in older documentation or migration notes.
