---
title: "Archived Automation Spec: audit_template"
...
# Archived Automation Spec: audit_template

## Purpose
Preserves the historical documentation record for `audit_template` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `audit_template` in older documentation or migration notes.
