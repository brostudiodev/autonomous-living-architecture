---
title: "Archived Automation Spec: S01_glances_system_monitor"
...
# Archived Automation Spec: S01_glances_system_monitor

## Purpose
Preserves the historical documentation record for `S01_glances_system_monitor` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `S01_glances_system_monitor` in older documentation or migration notes.
