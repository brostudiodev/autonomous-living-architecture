---
title: "Archived Automation Spec: check_activity_log"
...
# Archived Automation Spec: check_activity_log

## Purpose
Preserves the historical documentation record for `check_activity_log` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_activity_log` in older documentation or migration notes.
