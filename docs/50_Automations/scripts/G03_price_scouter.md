---
title: "Archived Automation Spec: G03_price_scouter"
...
# Archived Automation Spec: G03_price_scouter

## Purpose
Preserves the historical documentation record for `G03_price_scouter` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `G03_price_scouter` in older documentation or migration notes.
