---
title: "Archived Automation Spec: temp_check_view"
...
# Archived Automation Spec: temp_check_view

## Purpose
Preserves the historical documentation record for `temp_check_view` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_view` in older documentation or migration notes.
