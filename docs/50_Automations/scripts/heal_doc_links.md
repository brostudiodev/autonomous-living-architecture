---
title: "Archived Automation Spec: heal_doc_links"
...
# Archived Automation Spec: heal_doc_links

## Purpose
Preserves the historical documentation record for `heal_doc_links` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `heal_doc_links` in older documentation or migration notes.
