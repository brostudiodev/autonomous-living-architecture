---
title: "Archived Automation Spec: temp_inspect_pantry"
...
# Archived Automation Spec: temp_inspect_pantry

## Purpose
Preserves the historical documentation record for `temp_inspect_pantry` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_inspect_pantry` in older documentation or migration notes.
