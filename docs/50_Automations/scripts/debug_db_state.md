---
title: "Archived Automation Spec: debug_db_state"
...
# Archived Automation Spec: debug_db_state

## Purpose
Preserves the historical documentation record for `debug_db_state` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `debug_db_state` in older documentation or migration notes.
