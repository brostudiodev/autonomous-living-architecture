---
title: "Archived Automation Spec: cleanup_duplicates"
...
# Archived Automation Spec: cleanup_duplicates

## Purpose
Preserves the historical documentation record for `cleanup_duplicates` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `cleanup_duplicates` in older documentation or migration notes.
