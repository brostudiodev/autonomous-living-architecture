---
title: "Archived Automation Spec: check_schema"
...
# Archived Automation Spec: check_schema

## Purpose
Preserves the historical documentation record for `check_schema` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_schema` in older documentation or migration notes.
