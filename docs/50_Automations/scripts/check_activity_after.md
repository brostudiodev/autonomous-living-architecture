---
title: "Archived Automation Spec: check_activity_after"
...
# Archived Automation Spec: check_activity_after

## Purpose
Preserves the historical documentation record for `check_activity_after` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_activity_after` in older documentation or migration notes.
