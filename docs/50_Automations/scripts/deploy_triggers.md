---
title: "Archived Automation Spec: deploy_triggers"
...
# Archived Automation Spec: deploy_triggers

## Purpose
Preserves the historical documentation record for `deploy_triggers` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `deploy_triggers` in older documentation or migration notes.
