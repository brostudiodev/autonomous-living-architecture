---
title: "Archived Automation Spec: temp_check_missing"
...
# Archived Automation Spec: temp_check_missing

## Purpose
Preserves the historical documentation record for `temp_check_missing` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_missing` in older documentation or migration notes.
