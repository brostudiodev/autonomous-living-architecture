---
title: "Archived Automation Spec: temp_get_view_def"
...
# Archived Automation Spec: temp_get_view_def

## Purpose
Preserves the historical documentation record for `temp_get_view_def` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_get_view_def` in older documentation or migration notes.
