---
title: "Archived Automation Spec: temp_find_all_non_success"
...
# Archived Automation Spec: temp_find_all_non_success

## Purpose
Preserves the historical documentation record for `temp_find_all_non_success` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_find_all_non_success` in older documentation or migration notes.
