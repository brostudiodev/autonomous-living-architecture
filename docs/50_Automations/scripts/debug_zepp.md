---
title: "Archived Automation Spec: debug_zepp"
...
# Archived Automation Spec: debug_zepp

## Purpose
Preserves the historical documentation record for `debug_zepp` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `debug_zepp` in older documentation or migration notes.
