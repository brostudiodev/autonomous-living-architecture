---
title: "Archived Automation Spec: temp_check_biometrics"
...
# Archived Automation Spec: temp_check_biometrics

## Purpose
Preserves the historical documentation record for `temp_check_biometrics` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_biometrics` in older documentation or migration notes.
