---
title: "Archived Automation Spec: temp_list_views"
...
# Archived Automation Spec: temp_list_views

## Purpose
Preserves the historical documentation record for `temp_list_views` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_list_views` in older documentation or migration notes.
