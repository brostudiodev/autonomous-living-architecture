---
title: "Archived Automation Spec: test_endpoints"
...
# Archived Automation Spec: test_endpoints

## Purpose
Preserves the historical documentation record for `test_endpoints` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `test_endpoints` in older documentation or migration notes.
