---
title: "Archived Automation Spec: fix_precision"
...
# Archived Automation Spec: fix_precision

## Purpose
Preserves the historical documentation record for `fix_precision` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `fix_precision` in older documentation or migration notes.
