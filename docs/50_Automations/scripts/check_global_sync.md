---
title: "Archived Automation Spec: check_global_sync"
...
# Archived Automation Spec: check_global_sync

## Purpose
Preserves the historical documentation record for `check_global_sync` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_global_sync` in older documentation or migration notes.
