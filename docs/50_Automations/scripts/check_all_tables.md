---
title: "Archived Automation Spec: check_all_tables"
...
# Archived Automation Spec: check_all_tables

## Purpose
Preserves the historical documentation record for `check_all_tables` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_all_tables` in older documentation or migration notes.
