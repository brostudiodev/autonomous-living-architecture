---
title: "Archived Automation Spec: test_reflection_eps"
...
# Archived Automation Spec: test_reflection_eps

## Purpose
Preserves the historical documentation record for `test_reflection_eps` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `test_reflection_eps` in older documentation or migration notes.
