---
title: "Archived Automation Spec: temp_check_recent"
...
# Archived Automation Spec: temp_check_recent

## Purpose
Preserves the historical documentation record for `temp_check_recent` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_recent` in older documentation or migration notes.
