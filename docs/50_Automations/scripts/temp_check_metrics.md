---
title: "Archived Automation Spec: temp_check_metrics"
...
# Archived Automation Spec: temp_check_metrics

## Purpose
Preserves the historical documentation record for `temp_check_metrics` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_metrics` in older documentation or migration notes.
