---
title: "Archived Automation Spec: deploy_universal_triggers"
...
# Archived Automation Spec: deploy_universal_triggers

## Purpose
Preserves the historical documentation record for `deploy_universal_triggers` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `deploy_universal_triggers` in older documentation or migration notes.
