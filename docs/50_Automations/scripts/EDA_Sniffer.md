---
title: "Archived Automation Spec: EDA_Sniffer"
...
# Archived Automation Spec: EDA_Sniffer

## Purpose
Preserves the historical documentation record for `EDA_Sniffer` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `EDA_Sniffer` in older documentation or migration notes.
