---
title: "Archived Automation Spec: temp_get_merchants"
...
# Archived Automation Spec: temp_get_merchants

## Purpose
Preserves the historical documentation record for `temp_get_merchants` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_get_merchants` in older documentation or migration notes.
