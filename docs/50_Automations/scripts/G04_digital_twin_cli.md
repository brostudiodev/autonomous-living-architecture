---
title: "Archived Automation Spec: G04_digital_twin_cli"
...
# Archived Automation Spec: G04_digital_twin_cli

## Purpose
Preserves the historical documentation record for `G04_digital_twin_cli` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `G04_digital_twin_cli` in older documentation or migration notes.
