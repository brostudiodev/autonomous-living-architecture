---
title: "Archived Automation Spec: backfill_mood_historical"
...
# Archived Automation Spec: backfill_mood_historical

## Purpose
Preserves the historical documentation record for `backfill_mood_historical` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `backfill_mood_historical` in older documentation or migration notes.
