---
title: "Archived Automation Spec: check_all_links"
...
# Archived Automation Spec: check_all_links

## Purpose
Preserves the historical documentation record for `check_all_links` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_all_links` in older documentation or migration notes.
