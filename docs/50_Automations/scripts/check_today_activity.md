---
title: "Archived Automation Spec: check_today_activity"
...
# Archived Automation Spec: check_today_activity

## Purpose
Preserves the historical documentation record for `check_today_activity` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_today_activity` in older documentation or migration notes.
