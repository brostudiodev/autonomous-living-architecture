---
title: "Archived Automation Spec: fix_bare_exceptions"
...
# Archived Automation Spec: fix_bare_exceptions

## Purpose
Preserves the historical documentation record for `fix_bare_exceptions` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `fix_bare_exceptions` in older documentation or migration notes.
