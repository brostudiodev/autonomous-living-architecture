---
title: "Archived Automation Spec: G04_telegram_bot"
...
# Archived Automation Spec: G04_telegram_bot

## Purpose
Preserves the historical documentation record for `G04_telegram_bot` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `G04_telegram_bot` in older documentation or migration notes.
