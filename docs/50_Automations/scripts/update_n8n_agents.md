---
title: "Archived Automation Spec: update_n8n_agents"
...
# Archived Automation Spec: update_n8n_agents

## Purpose
Preserves the historical documentation record for `update_n8n_agents` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `update_n8n_agents` in older documentation or migration notes.
