---
title: "Archived Automation Spec: debug_zepp_dates"
...
# Archived Automation Spec: debug_zepp_dates

## Purpose
Preserves the historical documentation record for `debug_zepp_dates` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `debug_zepp_dates` in older documentation or migration notes.
