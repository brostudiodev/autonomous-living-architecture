---
title: "Archived Automation Spec: check_daily_manager"
...
# Archived Automation Spec: check_daily_manager

## Purpose
Preserves the historical documentation record for `check_daily_manager` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_daily_manager` in older documentation or migration notes.
