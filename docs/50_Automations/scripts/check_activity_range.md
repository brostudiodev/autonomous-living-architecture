---
title: "Archived Automation Spec: check_activity_range"
...
# Archived Automation Spec: check_activity_range

## Purpose
Preserves the historical documentation record for `check_activity_range` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_activity_range` in older documentation or migration notes.
