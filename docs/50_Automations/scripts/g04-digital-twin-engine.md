---
title: "Archived Automation Spec: g04-digital-twin-engine"
...
# Archived Automation Spec: g04-digital-twin-engine

## Purpose
Preserves the historical documentation record for `g04-digital-twin-engine` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `g04-digital-twin-engine` in older documentation or migration notes.
