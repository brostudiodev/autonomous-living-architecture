---
title: "Archived Automation Spec: temp_get_cats"
...
# Archived Automation Spec: temp_get_cats

## Purpose
Preserves the historical documentation record for `temp_get_cats` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_get_cats` in older documentation or migration notes.
