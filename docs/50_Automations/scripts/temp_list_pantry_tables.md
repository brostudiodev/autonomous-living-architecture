---
title: "Archived Automation Spec: temp_list_pantry_tables"
...
# Archived Automation Spec: temp_list_pantry_tables

## Purpose
Preserves the historical documentation record for `temp_list_pantry_tables` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_list_pantry_tables` in older documentation or migration notes.
