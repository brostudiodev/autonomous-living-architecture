---
title: "Archived Automation Spec: fix_docs_paths"
...
# Archived Automation Spec: fix_docs_paths

## Purpose
Preserves the historical documentation record for `fix_docs_paths` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `fix_docs_paths` in older documentation or migration notes.
