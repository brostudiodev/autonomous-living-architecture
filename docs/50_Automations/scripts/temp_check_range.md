---
title: "Archived Automation Spec: temp_check_range"
...
# Archived Automation Spec: temp_check_range

## Purpose
Preserves the historical documentation record for `temp_check_range` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_range` in older documentation or migration notes.
