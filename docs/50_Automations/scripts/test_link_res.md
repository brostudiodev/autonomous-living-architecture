---
title: "Archived Automation Spec: test_link_res"
...
# Archived Automation Spec: test_link_res

## Purpose
Preserves the historical documentation record for `test_link_res` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `test_link_res` in older documentation or migration notes.
