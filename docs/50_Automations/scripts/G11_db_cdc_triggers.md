---
title: "Archived Automation Spec: G11_db_cdc_triggers"
...
# Archived Automation Spec: G11_db_cdc_triggers

## Purpose
Preserves the historical documentation record for `G11_db_cdc_triggers` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `G11_db_cdc_triggers` in older documentation or migration notes.
