---
title: "Archived Automation Spec: check_all_triggers"
...
# Archived Automation Spec: check_all_triggers

## Purpose
Preserves the historical documentation record for `check_all_triggers` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_all_triggers` in older documentation or migration notes.
