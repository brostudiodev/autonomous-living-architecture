---
title: "Archived Automation Spec: deep_audit_links"
...
# Archived Automation Spec: deep_audit_links

## Purpose
Preserves the historical documentation record for `deep_audit_links` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `deep_audit_links` in older documentation or migration notes.
