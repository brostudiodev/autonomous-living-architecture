---
title: "Archived Automation Spec: G11_inbox_router"
...
# Archived Automation Spec: G11_inbox_router

## Purpose
Preserves the historical documentation record for `G11_inbox_router` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `G11_inbox_router` in older documentation or migration notes.
