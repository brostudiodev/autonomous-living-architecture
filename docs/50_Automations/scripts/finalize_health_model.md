---
title: "Archived Automation Spec: finalize_health_model"
...
# Archived Automation Spec: finalize_health_model

## Purpose
Preserves the historical documentation record for `finalize_health_model` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `finalize_health_model` in older documentation or migration notes.
