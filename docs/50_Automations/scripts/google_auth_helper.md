---
title: "Archived Automation Spec: google_auth_helper"
...
# Archived Automation Spec: google_auth_helper

## Purpose
Preserves the historical documentation record for `google_auth_helper` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `google_auth_helper` in older documentation or migration notes.
