---
title: "Archived Automation Spec: temp_check_schema"
...
# Archived Automation Spec: temp_check_schema

## Purpose
Preserves the historical documentation record for `temp_check_schema` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_schema` in older documentation or migration notes.
