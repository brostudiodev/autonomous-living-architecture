---
title: "Archived Automation Spec: obsidian_link_audit"
...
# Archived Automation Spec: obsidian_link_audit

## Purpose
Preserves the historical documentation record for `obsidian_link_audit` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `obsidian_link_audit` in older documentation or migration notes.
