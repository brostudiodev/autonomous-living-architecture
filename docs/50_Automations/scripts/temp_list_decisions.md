---
title: "Archived Automation Spec: temp_list_decisions"
...
# Archived Automation Spec: temp_list_decisions

## Purpose
Preserves the historical documentation record for `temp_list_decisions` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_list_decisions` in older documentation or migration notes.
