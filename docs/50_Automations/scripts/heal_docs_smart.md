---
title: "Archived Automation Spec: heal_docs_smart"
...
# Archived Automation Spec: heal_docs_smart

## Purpose
Preserves the historical documentation record for `heal_docs_smart` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `heal_docs_smart` in older documentation or migration notes.
