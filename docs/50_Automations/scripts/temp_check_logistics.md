---
title: "Archived Automation Spec: temp_check_logistics"
...
# Archived Automation Spec: temp_check_logistics

## Purpose
Preserves the historical documentation record for `temp_check_logistics` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_logistics` in older documentation or migration notes.
