---
title: "Archived Automation Spec: check_cache_data_v2"
...
# Archived Automation Spec: check_cache_data_v2

## Purpose
Preserves the historical documentation record for `check_cache_data_v2` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_cache_data_v2` in older documentation or migration notes.
