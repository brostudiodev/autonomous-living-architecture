---
title: "Archived Automation Spec: G04_unified_search"
...
# Archived Automation Spec: G04_unified_search

## Purpose
Preserves the historical documentation record for `G04_unified_search` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `G04_unified_search` in older documentation or migration notes.
