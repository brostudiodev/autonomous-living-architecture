---
title: "Archived Automation Spec: temp_check_script_names"
...
# Archived Automation Spec: temp_check_script_names

## Purpose
Preserves the historical documentation record for `temp_check_script_names` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_script_names` in older documentation or migration notes.
