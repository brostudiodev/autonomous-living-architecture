---
title: "Archived Automation Spec: G05_person_specific_tracking"
...
# Archived Automation Spec: G05_person_specific_tracking

## Purpose
Preserves the historical documentation record for `G05_person_specific_tracking` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `G05_person_specific_tracking` in older documentation or migration notes.
