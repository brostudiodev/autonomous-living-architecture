---
title: "Archived Automation Spec: G04_agent_zero_core"
...
# Archived Automation Spec: G04_agent_zero_core

## Purpose
Preserves the historical documentation record for `G04_agent_zero_core` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `G04_agent_zero_core` in older documentation or migration notes.
