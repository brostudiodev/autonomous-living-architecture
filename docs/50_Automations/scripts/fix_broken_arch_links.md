---
title: "Archived Automation Spec: fix_broken_arch_links"
...
# Archived Automation Spec: fix_broken_arch_links

## Purpose
Preserves the historical documentation record for `fix_broken_arch_links` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `fix_broken_arch_links` in older documentation or migration notes.
