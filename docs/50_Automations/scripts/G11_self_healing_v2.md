---
title: "Archived Automation Spec: G11_self_healing_v2"
...
# Archived Automation Spec: G11_self_healing_v2

## Purpose
Preserves the historical documentation record for `G11_self_healing_v2` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `G11_self_healing_v2` in older documentation or migration notes.
