---
title: "Archived Automation Spec: temp_check_zone_in"
...
# Archived Automation Spec: temp_check_zone_in

## Purpose
Preserves the historical documentation record for `temp_check_zone_in` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_zone_in` in older documentation or migration notes.
