---
title: "Archived Automation Spec: heal_docs"
...
# Archived Automation Spec: heal_docs

## Purpose
Preserves the historical documentation record for `heal_docs` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `heal_docs` in older documentation or migration notes.
