---
title: "Archived Automation Spec: temp_check_columns"
...
# Archived Automation Spec: temp_check_columns

## Purpose
Preserves the historical documentation record for `temp_check_columns` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_columns` in older documentation or migration notes.
