---
title: "Archived Automation Spec: G11_task_hygiene_hardened"
...
# Archived Automation Spec: G11_task_hygiene_hardened

## Purpose
Preserves the historical documentation record for `G11_task_hygiene_hardened` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `G11_task_hygiene_hardened` in older documentation or migration notes.
