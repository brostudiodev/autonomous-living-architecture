---
title: "Archived Automation Spec: check_cache_data"
...
# Archived Automation Spec: check_cache_data

## Purpose
Preserves the historical documentation record for `check_cache_data` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_cache_data` in older documentation or migration notes.
