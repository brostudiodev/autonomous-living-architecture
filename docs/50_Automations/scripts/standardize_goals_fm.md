---
title: "Archived Automation Spec: standardize_goals_fm"
...
# Archived Automation Spec: standardize_goals_fm

## Purpose
Preserves the historical documentation record for `standardize_goals_fm` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `standardize_goals_fm` in older documentation or migration notes.
