---
title: "Archived Automation Spec: check_db_times"
...
# Archived Automation Spec: check_db_times

## Purpose
Preserves the historical documentation record for `check_db_times` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_db_times` in older documentation or migration notes.
