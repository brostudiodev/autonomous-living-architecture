---
title: "Archived Automation Spec: harden_proxies"
...
# Archived Automation Spec: harden_proxies

## Purpose
Preserves the historical documentation record for `harden_proxies` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `harden_proxies` in older documentation or migration notes.
