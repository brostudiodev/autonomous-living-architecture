---
title: "Archived Automation Spec: temp_check_roi"
...
# Archived Automation Spec: temp_check_roi

## Purpose
Preserves the historical documentation record for `temp_check_roi` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_roi` in older documentation or migration notes.
