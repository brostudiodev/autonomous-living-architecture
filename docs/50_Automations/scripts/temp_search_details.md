---
title: "Archived Automation Spec: temp_search_details"
...
# Archived Automation Spec: temp_search_details

## Purpose
Preserves the historical documentation record for `temp_search_details` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_search_details` in older documentation or migration notes.
