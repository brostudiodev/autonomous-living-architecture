---
title: "Archived Automation Spec: temp_check_now"
...
# Archived Automation Spec: temp_check_now

## Purpose
Preserves the historical documentation record for `temp_check_now` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_now` in older documentation or migration notes.
