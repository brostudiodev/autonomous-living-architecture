---
title: "Archived Automation Spec: check_biometrics_today"
...
# Archived Automation Spec: check_biometrics_today

## Purpose
Preserves the historical documentation record for `check_biometrics_today` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_biometrics_today` in older documentation or migration notes.
