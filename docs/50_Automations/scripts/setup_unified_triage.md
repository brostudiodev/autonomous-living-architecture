---
title: "Archived Automation Spec: setup_unified_triage"
...
# Archived Automation Spec: setup_unified_triage

## Purpose
Preserves the historical documentation record for `setup_unified_triage` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `setup_unified_triage` in older documentation or migration notes.
