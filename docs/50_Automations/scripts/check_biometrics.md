---
title: "Archived Automation Spec: check_biometrics"
...
# Archived Automation Spec: check_biometrics

## Purpose
Preserves the historical documentation record for `check_biometrics` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_biometrics` in older documentation or migration notes.
