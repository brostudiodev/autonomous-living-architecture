---
title: "Archived Automation Spec: fix_imports"
...
# Archived Automation Spec: fix_imports

## Purpose
Preserves the historical documentation record for `fix_imports` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `fix_imports` in older documentation or migration notes.
