---
title: "Archived Automation Spec: G02_content_engine"
...
# Archived Automation Spec: G02_content_engine

## Purpose
Preserves the historical documentation record for `G02_content_engine` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `G02_content_engine` in older documentation or migration notes.
