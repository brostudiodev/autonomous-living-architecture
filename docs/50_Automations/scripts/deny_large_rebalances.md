---
title: "Archived Automation Spec: deny_large_rebalances"
...
# Archived Automation Spec: deny_large_rebalances

## Purpose
Preserves the historical documentation record for `deny_large_rebalances` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `deny_large_rebalances` in older documentation or migration notes.
