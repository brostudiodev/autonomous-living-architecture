---
title: "Archived Automation Spec: debug_check_tables"
...
# Archived Automation Spec: debug_check_tables

## Purpose
Preserves the historical documentation record for `debug_check_tables` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `debug_check_tables` in older documentation or migration notes.
