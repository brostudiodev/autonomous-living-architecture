---
title: "Archived Automation Spec: temp_list_pending"
...
# Archived Automation Spec: temp_list_pending

## Purpose
Preserves the historical documentation record for `temp_list_pending` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_list_pending` in older documentation or migration notes.
