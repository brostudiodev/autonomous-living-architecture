---
title: "Archived Automation Spec: G12_knowledge_retrieval"
...
# Archived Automation Spec: G12_knowledge_retrieval

## Purpose
Preserves the historical documentation record for `G12_knowledge_retrieval` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `G12_knowledge_retrieval` in older documentation or migration notes.
