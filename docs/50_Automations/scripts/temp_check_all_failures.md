---
title: "Archived Automation Spec: temp_check_all_failures"
...
# Archived Automation Spec: temp_check_all_failures

## Purpose
Preserves the historical documentation record for `temp_check_all_failures` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_all_failures` in older documentation or migration notes.
