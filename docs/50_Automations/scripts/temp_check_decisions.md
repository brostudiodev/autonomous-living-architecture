---
title: "Archived Automation Spec: temp_check_decisions"
...
# Archived Automation Spec: temp_check_decisions

## Purpose
Preserves the historical documentation record for `temp_check_decisions` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `temp_check_decisions` in older documentation or migration notes.
