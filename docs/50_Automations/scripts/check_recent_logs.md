---
title: "Archived Automation Spec: check_recent_logs"
...
# Archived Automation Spec: check_recent_logs

## Purpose
Preserves the historical documentation record for `check_recent_logs` after no matching active Python script was found in `scripts/` or `modules/<domain>/scripts/`.
...
## Inputs/Outputs
### Inputs
- Historical references to `check_recent_logs` in older documentation or migration notes.
