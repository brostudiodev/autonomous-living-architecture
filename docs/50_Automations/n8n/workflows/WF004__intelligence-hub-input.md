...
```json
{
  "message": {
    "message_id": 123,
    "from": { "id": {{TELEGRAM_CHAT_ID}}, "username": "user" },
...
Telegram Bot API 	Message receiving, file download 	Bot token via n8n credential
...

{
  ...
  "authorized_user_id": "{{TELEGRAM_CHAT_ID}}"
}
