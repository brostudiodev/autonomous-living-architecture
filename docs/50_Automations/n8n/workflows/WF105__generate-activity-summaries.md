...
## Purpose
Automatically generate milestone-level Activity-log.md summaries from daily Activity-log.md entries across all 12 goals in the autonomous-living repository.
...
7. **Handle Activity-log.md File:**
   - Check if existing Activity-log.md file exists
...
- **Duplicate Prevention:** Skips if week already processed in Activity-log.md
...
## Outputs
- **Updated Activity-log.md files:** `docs/10_Goals/GXX_*/Activity-log.md` in GitHub repository
...
- **GitHub Commits:** Individual commits for each updated Activity-log.md with format `=WF105: Weekly activity summary for GOALID - YYYY-WXX`
...
## Dependencies
### Systems
- [S03 Data Layer](../../../20_Systems/README.md) - For activity log storage structure
- [S08 Automation Orchestrator](../../../20_Systems/README.md) - For workflow execution
...
## Monitoring
- Success metric: All Activity-log.md files updated weekly
...
#    d. Create or update Activity-log.md with new weekly section:
...
git add docs/10_Goals/*/Activity-log.md
...
- [S03 Data Layer README](../../../20_Systems/README.md)
...
- `GitHub Get Existing Activity-log.md` - Checks for existing summary file
- `Check File Exists` - Code node determines if binary data present
- `Extract Existing Activity-log.md` - Gets current content for merging
...
- `GitHub Update Activity-log.md` - Commits changes to repository
...
1. Check if Activity-log.md exists in goal folder
