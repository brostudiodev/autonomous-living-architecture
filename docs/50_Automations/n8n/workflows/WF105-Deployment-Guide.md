...
## Overview
WF105 generates weekly activity summaries from Activity-log.md files and updates Activity-log.md milestone entries.
...
{{ROOT_LOCATION}}/autonomous-living/docs/10_Goals/
{{ROOT_LOCATION}}/autonomous-living/docs/_meta/weekly-summaries/
```
...
ls -la {{ROOT_LOCATION}}/autonomous-living/docs/_meta/weekly-summaries/

# Verify Activity-log.md updates:
find {{ROOT_LOCATION}}/autonomous-living/docs/10_Goals/ -name "Activity-log.md" -exec head -20 {} \;

# Check weekly report content:
cat {{ROOT_LOCATION}}/autonomous-living/docs/_meta/weekly-summaries/*.md
```
...
- Check Activity-log.md files for new milestone entries
...
sudo chown -R n8n:n8n {{ROOT_LOCATION}}/autonomous-living/docs/
sudo chmod -R 755 {{ROOT_LOCATION}}/autonomous-living/docs/
```
...
find {{ROOT_LOCATION}}/autonomous-living/docs/10_Goals/ -name "Activity-log.md"

# Check recent entries exist
grep -r "2026-" {{ROOT_LOCATION}}/autonomous-living/docs/10_Goals/*/Activity-log.md
```
...
# 3. Restore Activity-log.md files from git if needed:
cd {{ROOT_LOCATION}}/autonomous-living
git checkout -- docs/10_Goals/*/Activity-log.md
...
- [x] Activity-log.md files updated with new milestone entries
