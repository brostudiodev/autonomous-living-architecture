...
```javascript
// ============================================
// HANDLE: /help command (Total Autonomy Edition)
// ============================================
...
/status - Full system summary (Health, Finance, Pantry)
/health - Detailed biometric & recovery status
/today - \U0001f4f1 Today's Mobile Dashboard (Obsidian Live)
/audit - \U0001f6e1\ufe0f Self-healing system integrity check
/map - G11 System connectivity matrix
/help - This directory

*Planning & Sync:*
/todos - \U0001f4c5 Unified Agenda (Today, Tomorrow, 7 Days)
/tomorrow | /briefing - \U0001f319 Tomorrow's Mission Briefing
/plan | /evening - Today's review & evening checklist
/tasks (Q1|Q2) - Show roadmap goals
/sync - \U0001f504 Force global data sync (Internal <-> External)

*Intelligence & ROI:*
/os - \U0001f9e0 Personal Meta-Optimization (Director's Advice)
/intel - Strategic intelligence activator
/predict - \U0001f9e0 AI Readiness & Energy prediction
/roi - Autonomy ROI (Total Time Saved stats)
/report - Monthly strategic progress summary
/vision - North Star & 2026 Power Goals dashboard

*Execution (Close the Loop):*
/log (GID) (Did) - \u26a1 Quick log a "Win" to any goal
/workout log - Trigger smart workout logging flow
/pantry (query) - AI Agent inventory management
/execute (mode) - Trigger Smart Home environment (G08)

*Finance:*
/finance | /budget - Budget status & alert reconciliation

*Brand (Automationbro):*
/harvest - \U0001f916 Draft fresh Automationbro content ideas
/substack sync - Sync posts to Obsidian
/coffee - \u2615 Support the architecture (Ko-fi/Stripe)

*Prefixes:*
\u2022 note: - Save to Obsidian Inbox
\u2022 task: - Create a Google Task
\u2022 idea: - Capture a strategic idea
\u2022 log: - Add entry to goal activity log
