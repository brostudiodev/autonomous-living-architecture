...
- **G05_bank_ingest.py**: Imports transactions from bank CSVs/APIs. [Doc](./modules/finance/scripts/G05_bank_ingest.py)
...
- **G11_event_listener.py**: The master EDA consumer. Handles Training, Learning, Career, and Content domains + granular DB events. [Doc](scripts/G11_event_listener.md)
