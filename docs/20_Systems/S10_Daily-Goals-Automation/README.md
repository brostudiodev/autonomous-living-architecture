...
- **Markdown Logs:** `goal-gXX/Activity-log.md`.
...
├── goal-g01/Activity-log.md                # Goal-specific activity logs
├── goal-g02/Activity-log.md
└── goal-g12/Activity-log.md
```
...
# Check activity logs
ls -la autonomous-living/goal-g*/Activity-log.md
