...
## Purpose
Automatically generate milestone-level ACTIVITY.md summaries from daily ACTIVITY_LOG.md entries across all 12 goals in the autonomous-living repository.
...
- **File Format:** ACTIVITY_LOG.md with structured daily entries
...
3. **Fetch Activity Log:** Get ACTIVITY_LOG.md from GitHub repository
...
|---|---|---|---|
| Missing ACTIVITY_LOG.md | GitHub API 404 error | Continue to next goal | Include as "no_activity" in report |
...
- `GitHub Get Activity Log` - Fetches ACTIVITY_LOG.md from repository
