...
## Enabling systems
- [S03 Data Layer](../../20_Systems/README.md) - PostgreSQL `autonomous_health` database.
- [S06 Health Performance](../../20_Systems/README.md) - Biometric analysis and training integration.

## Traceability (Outcome → System → Automation → SOP/Runbook)
| Outcome | System | Automation | SOP/Runbook |
|---|---|---|---|
| Automated HR/Sleep Sync | S06 Health | [script: G07_zepp_sync.py](../../50_Automations/scripts/G07_zepp_sync.md) (Hardened with Morning Window retry) | - |
| Automated Weight/Body Fat Sync | S06 Health | [script: G07_withings_direct_sync.py](../../50_Automations/scripts/G07_withings_direct_sync.md) | - |
...
| Biological Readiness Scoring | S03 Data Layer | [autonomous_daily_manager.py](../../50_Automations/scripts/autonomous_daily_manager.md) (Hardened with Emergency Sync Guard) | - |
