...
## 🌟 What you achieve
*   **Real Financial Truth:** Eliminate "fake" savings rates and see exactly how much wealth you are building each month.
*   **Automatic Budget Alerts:** Get notified on Telegram the moment you approach a spending limit.
*   **Situational Awareness:** A single Grafana dashboard that shows your P&L, upcoming expenses, and cash flow in seconds.
*   **Self-Driving Data:** n8n workflows handle the heavy lifting of moving data between your spreadsheets and the database.
