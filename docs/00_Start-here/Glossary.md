...
- **[Decoupling](../docs/00_Start-here/Principles.md):** Designing systems so they can function independently. (e.g., the Digital Twin can calculate state even if Telegram is down).
...
- **[Intelligence Router (S11)](../20_Systems/S11_Intelligence_Router/README.md):** The AI component that analyzes incoming messages (e.g., via Telegram) and decides which system should handle the request.
- **[Gemini 1.5 Pro/Flash:](../docs/00_Start-here/Principles.md)** The primary Large Language Models (LLMs) used for natural language processing and decision support.
- **[Intent Recognition:](../20_Systems/S11_Intelligence_Router/README.md)** The process of the AI understanding *what* you want to do (e.g., "Add milk" -> Intent: `pantry_update`).
...
- **[Mission Refractor:](../docs/50_Automations/scripts/G11-mission-refractor.md)** A specialized script that analyzes Git commits and Roadmaps to draft your daily activity logs automatically.
...
- **[Real Savings Rate:](../docs/60_Decisions_adrs/Adr-0008-Real-Savings-Rate-Calculation.md)** A calculation that excludes internal transfers and "fake" accounting artifacts to show your actual wealth growth.

---

## 📓 Second Brain & Productivity (G10, G12)

- **[Obsidian:](../docs/00_Start-here/03_Quick-Start-Guide.md)** The markdown-based note-taking app used as your "Second Brain" and primary interface for documentation.
- **[Daily Note:](../docs/00_Start-here/03_Quick-Start-Guide.md)** The central note created every day that acts as your dashboard for tasks, missions, and metrics.
...
- **[Dataview:](../docs/00_Start-here/03_Quick-Start-Guide.md)** An Obsidian plugin that allows you to query your notes like a database.
- **[MINS (Most Important Next Step):](../docs/00_Start-here/04_FAQ.md)** The single most impactful task for a goal, identified daily to prevent decision fatigue.
...
- **[Zepp / Amazfit:](../docs/50_Automations/scripts/G07-zepp-sync.md)** The platform used to capture daily activity and sleep data from wearables.
- **[Withings:](../docs/50_Automations/scripts/G07-weight-sync.md)** The smart scale ecosystem used for high-precision body composition tracking.
