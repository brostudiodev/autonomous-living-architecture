...
| Grafana | observability dashboards | Docker Compose | high | G02 Finance dashboards, system monitoring |
...
|---|---|---|---|---|
| Finance data ingestion | Bank statements & CSV import | WF103 (4-hourly) | n8n workflow | G02 - transaction processing |
| Budget alerts | Threshold monitoring | WF102 (daily) | n8n workflow | G02 - financial notifications |
...
|---|---|---|---|---|
| Google Sheets API | Transaction data source | Google | Standard | G02 data import |
