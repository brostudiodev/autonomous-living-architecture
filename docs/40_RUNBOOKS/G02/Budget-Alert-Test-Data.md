---
title: "G02: Budget Alert Test Data"
type: "test_data"
status: "complete"
goal_id: "goal-g02"
created: "2026-02-10"
...
### TC-G02-BA-001: Spending exceeds 80% threshold for a category
...
### TC-G02-BA-002: Spending exactly meets 80% threshold for a category
...
### TC-G02-BA-003: Spending exceeds 100% threshold for a category
...
### TC-G02-BA-004: Spending is below 80% threshold for all categories
...
### TC-G02-BA-005: Category with $0 budget has spending
...
### TC-G02-BA-006: Projected month-end spending exceeds budget
...
1. **Run TC-G02-BA-001** - Verify HIGH severity alert for 80% breach
2. **Run TC-G02-BA-002** - Verify HIGH severity alert exactly at 80%
3. **Run TC-G02-BA-003** - Verify CRITICAL severity alert for 100%+ breach
4. **Run TC-G02-BA-004** - Verify no alerts for healthy spending
5. **Run TC-G02-BA-005** - Verify no alerts for category with $0 budget
6. **Run TC-G02-BA-006** - Verify MEDIUM severity alert for projected overspend
...
- **TC-G02-BA-001/002**: "Check Budget Threshold" node → "Send Alert" node → HIGH severity
- **TC-G02-BA-003**: "Check Budget Threshold" node → "Send Critical Alert" node → CRITICAL severity  
- **TC-G02-BA-004**: No trigger (or "Send On Track Update" if configured)
- **TC-G02-BA-005**: No trigger (budget = 0)
- **TC-G02-BA-006**: "Check Projected Overspend" node → "Send Alert" node → MEDIUM severity