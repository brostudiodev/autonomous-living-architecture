---
title: "G02: Validate Savings Rate Calculation"
type: "runbook"
status: "draft"
goal_id: "goal-g02"
owner: "Michał"
...
## 2. Scope
This runbook applies to the `autonomous-living` financial data layer, specifically the PostgreSQL database and the Grafana dashboard for G02.

## 3. Prerequisites
-   Access to the PostgreSQL database (via `psql` or a GUI tool).
-   Access to the Grafana instance with the "G02 - Financial Command Center" dashboard configured.
...
1.  Refresh the "G02 - Financial Command Center" Grafana dashboard.
