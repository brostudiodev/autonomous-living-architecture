...
LINKEDIN_CONFIG = {
    ...
    "client_secret: "{{GENERIC_API_SECRET}}",
...
TWITTER_CONFIG = {
    ...
    "consumer_secret: "{{GENERIC_API_SECRET}}",
    "access_token: "{{GENERIC_API_SECRET}}",
    "access_token_secret: "{{GENERIC_API_SECRET}}"
}

# Initialize client
client = tweepy.Client(
    consumer_key=TWITTER_CONFIG["consumer_key"],
    consumer_secret: "{{GENERIC_API_SECRET}}"["consumer_secret"],
    access_token: "{{GENERIC_API_SECRET}}"["access_token"],
    access_token_secret: "{{GENERIC_API_SECRET}}"["access_token_secret"]
)
```
...
class SubstackEmailPublisher:
    def __init__(self, smtp_config):
        ...
        self.password: "{{GENERIC_API_SECRET}}"["password"]
...
class WebsitePublisher:
    def __init__(self, config):
        ...
        self.api_key: "{{GENERIC_API_SECRET}}".get("api_key")
